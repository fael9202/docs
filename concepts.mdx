...
### Valor de Conversão
Quantidade em reais (BRL) ou cripto alvo envolvida no payin, conforme `currency_type`.

### Taxa de Conversão
Taxa aplicada sobre o payin (spread + tarifas). Define o valor final em cripto.

## Cotações e Preços (Payin)
